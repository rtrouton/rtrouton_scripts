...
# Java 8 Update 40, but the XML address embedded with Java 8 Update 40 is not special in 
...
#
# As of Java 8 Update 40, that produces the following return:
#
# https://javadl-esd-secure.oracle.com/update/mac/au-1.8.0_40.xml
#

OracleUpdateXML="https://javadl-esd-secure.oracle.com/update/mac/au-1.8.0_40.xml"
