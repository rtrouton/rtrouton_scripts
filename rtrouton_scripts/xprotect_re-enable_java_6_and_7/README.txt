...
The script is named xprotect_re-enable_java_6_and_7.sh and is put into /Library/Scripts along with a LaunchAgent named com.company.xprotect_re-enable_java_6_and_7.plist that's put into /Library/LaunchDaemons. 
