Uses a script named xprotect_re-enable_java_6_and_7.sh that's put into /Library/Scripts and a LaunchAgent named com.company.xprotect_re-enable_java_6_and_7.plist that's put into /Library/LaunchDaemons. This script will check the current Java 6 and Java 7 browser plug-in versions and compare them against the minimum version allowed by Apple's XProtect malware protection. 
