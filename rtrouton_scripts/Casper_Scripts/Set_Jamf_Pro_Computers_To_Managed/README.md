This script is designed to update the management status in the computer inventory record from `Not Managed` to `Managed` using the Jamf Pro API. Five items are required to use this script:
