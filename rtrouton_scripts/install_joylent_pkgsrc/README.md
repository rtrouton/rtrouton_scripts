This script will download an OS-appropriate gzipped tar file from Joylent and install pkgsrc using the bootstrap installer stored inside the downloaded tar file.
